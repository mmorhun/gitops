module github.com/mmorhun/gitops
...
require (
	...
	github.com/mmorhun/api v0.0.0-20220415090539-17b4efece3da
	github.com/openshift/api v3.9.0+incompatible
	github.com/redhat-appstudio/application-service v0.0.0-20220411161946-75a4c79e49ab
	github.com/spf13/afero v1.8.2
	github.com/tektoncd/pipeline v0.33.0
	github.com/tektoncd/triggers v0.19.1
	k8s.io/api v0.23.5
	// The following k8s.io deps must be in sync with the above
