...
import (
	...
	componentv1alpha1 "github.com/mmorhun/api/component/v1alpha1"
	"github.com/mmorhun/gitops/resources"
	yaml "github.com/mmorhun/gitops/yaml"
...
func determineBuildPipeline(component componentv1alpha1.Component) string {
...
func getParamsForComponentBuild(component componentv1alpha1.Component, isInitialBuild bool) []tektonapi.Param {
...
func getBuildCommonLabelsForComponent(component *componentv1alpha1.Component) map[string]string {
